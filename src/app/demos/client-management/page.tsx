    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <p className="text-2xl font-semibold mt-2">{leadsData.length}</p>
        </div>
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h3 className="text-gray-400 text-sm font-medium">Active Deals</h3>
          <p className="text-2xl font-semibold mt-2">{dealsData.length}</p>
        </div>
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h3 className="text-gray-400 text-sm font-medium">Total Deal Value</h3>
          <p className="text-2xl font-semibold mt-2">€{totalDealsAmount.toLocaleString()}</p>
        </div>
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
